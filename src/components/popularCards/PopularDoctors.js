...
export default function PopularDoctors(props) {
  return (
    <div className={props.size}>
      ...
      >
        <div className="mm-card-content mt-3">
          <h4 className="text-dark text-center">Popular Doctors</h4>
          ...
          <ul class="list-group list-group-flush bg-white px-4 py-4">
            <li class="list-group-item  bg-white">
              ...
              <b className="text-dark text-lg">Doctor&nbsp;Name</b>
              <sub className="text-dark ">(Medicine)</sub>
            </li>
            <li class="list-group-item  bg-white">
              <img
                src="https://image.freepik.com/free-vector/doctor-character-background_1270-84.jpg"
