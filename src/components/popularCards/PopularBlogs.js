...
export default class PopularBlogs extends React.Component {
  constructor(props) {
    super(props);
          ...
          <div className="mm-card-content mt-3">
            ...
            {this.state.recent_blogs.length >= 4 ? (
              <ul class="list-group list-group-flush bg-white px-4 py-3">
                ...
                <li class="list-group-item  bg-white">
                  <b className="text-dark mr-2 text-lg">
                    {this.state.recent_blogs[1].title}
                  </b>
                  <small className="text-right ml-4">
                    <br />
                ...
                <li class="list-group-item  bg-white">
                  <b className="text-dark mr-2 text-lg">
                    {this.state.recent_blogs[2].title}
                  </b>
                  <small className="text-right ml-4">
                    <br />
                ...
                <li class="list-group-item  bg-white">
                  <b className="text-dark mr-2 text-lg">
                    {this.state.recent_blogs[3].title}
                  </b>
                  <small className="text-right ml-4">
                    <br />
                    {this.state.recent_blogs[3].category}
                  </small>
                </li>
